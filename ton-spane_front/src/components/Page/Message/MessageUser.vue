...
/* Стили для текстовых элементов внутри профиля */
.info-container-profile h3 {
    margin: 0;
    font-size: 1.1em;
    font-weight: 600;
    color: #fff;
...
/* Улучшенные стили для hover состояний */
.container-profile:hover .container-img img {
    transform: scale(1.05);
